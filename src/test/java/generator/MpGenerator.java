...
public class MpGenerator {
	...
	public MpGenerator(String modular,DataSourceConfig dataSourceConfig,String[] tables,String[] prefixs,String outPutPath,String author){
		if(outPutPath != null){
            ...
            File outFile = new File(resource.getPath(),"../../src/generator/java");
            if(!outFile.exists()){
                outFile.mkdirs();
            }
	...
	public MpGenerator init(){
      ...
      // strategy.setCapitalMode(true);// 全局大写命名 ORACLE 注意
        ...
        // strategy.setExclude(new String[]{"test"}); // 排除生成的表
         // 自定义实体父类
         // strategy.setSuperEntityClass("weixin.entity.BaseModel");
         // 自定义实体，公共字段
      ...
      // 包配置
         ...
         pc.setParent("com.example.appointment.modular."+modular);
