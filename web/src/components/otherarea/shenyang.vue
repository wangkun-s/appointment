...
<script>
  export default {
    ...
    data(){
      return {
        //定义指定地点的名称和经纬度
        buildinglist: [{ name: '沈阳工业大学分诊所', details:'详情',j: 123.2589397000, w: 41.7450385600 },
          { name: '沈阳市浑南区沈中大街分诊所', details:'详情',j: 123.4743993400, w:41.6852334300 },
          { name: '沈阳市儿童图书馆分诊所',details:'详情', j: 123.4600384600, w: 41.6826256500 }],
