...
<script>
  export default {
    ...
    data(){
      return {
        //定义指定地点的名称和经纬度
        buildinglist: [{ name: '锦州市古塔区北安路分诊所',details:'详情', j: 121.1310231000, w: 41.1452690700 },
          { name: '锦州市太和区科技路分诊所', details:'详情',j: 123.0044990100, w:41.1229883800 },
          { name: '锦州市太和区凌西大街分诊所',details:'详情', j: 121.1118710000, w: 41.1080863500 }],
        jd: 121.1310231000,  //初始地图中心点的经纬度
        wd: 41.1452690700,
        map: {},
        point: {},
      }
