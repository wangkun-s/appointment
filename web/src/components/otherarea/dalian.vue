...
<script>
    export default {
      ...
      data(){
        return {
          //定义指定地点的名称和经纬度
          buildinglist: [{ name: '大连医好连锁口腔医院总院', details:'详情',j: 121.593477781, w: 38.9487099383 },
            { name: '大连理工大学分诊所', details:'详情',j: 121.669802, w:38.888455  },
            { name: '大连罗斯福分诊所', details:'详情',j: 121.5930157600, w: 38.9187996500 },
            { name: '大连辛寨子广场分诊所', details:'详情',j: 121.5230413500, w:38.9700629200 }],
